...
const iconLib = {
  FontAwesome: (name: string, size: number, color: string) => (
    <FontAwesome name={name} color={color} size={size} />
  ),
  FontAwesome5: (name: string, size: number, color: string) => (
    <FontAwesome5 name={name} color={color} size={size} />
  ),
  FontAwesome6: (name: string, size: number, color: string) => (
    <FontAwesome6 name={name} color={color} size={size} />
  ),
  MaterialIcons: (name: string, size: number, color: string) => (
    <MaterialIcons name={name} color={color} size={size} />
  ),
  MaterialCommunityIcons: (name: string, size: number, color: string) => (
    <MaterialCommunityIcons name={name} color={color} size={size} />
  ),
  Ionicons: (name: string, size: number, color: string) => (
    <Ionicons name={name} color={color} size={size} />
  ),
  Fontisto: (name: string, size: number, color: string) => (
    <Fontisto name={name} color={color} size={size} />
  ),
  AntDesign: (name: string, size: number, color: string) => (
    <AntDesign name={name} color={color} size={size} />
  ),
  Octicons: (name: string, size: number, color: string) => (
...
const IconMapper: React.FC<IconMapperProps> = ({ iconName, size = 20, color = 'white' }) => {
  ...
  return <>{iconLib[iconData.library](iconData.name, size, color)}</>;
};
