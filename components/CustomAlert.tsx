...
import { Modal, View, Text, Pressable, StyleSheet, ActivityIndicator, Image } from 'react-native';
    ...
    <Modal transparent={true} visible={isVisible} animationType="slide" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.alertContainer}>
          ...
          <Text
            style={[styles.text, { textAlign: alignText }, textColor ? { color: textColor } : null]}
          >
            {text}
          </Text>
          {isLoading ? (
